...
/// </summary>
public class ARInteractorMoleculeSpawnTrigger : MonoBehaviour
{
    /// <summary>
    ...
    XRRayInteractor m_ARInteractorObject;

    /// <summary>
    /// The <see cref="IARInteractor"/> that determines where to spawn the object.
    /// </summary>
    public XRRayInteractor arInteractorObject
    {
    ...
    MoleculeSpawner m_ObjectSpawner;

    /// <summary>
    /// The behavior to use to spawn objects.
    /// </summary>
    public MoleculeSpawner objectSpawner
    {
        get => m_ObjectSpawner;
...
#else
            m_ObjectSpawner = FindObjectOfType<MoleculeSpawner>();
#endif
